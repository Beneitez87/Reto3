...
<head>
  ...
  <link rel="stylesheet" href="../style/estiloConFondoPrincipio.css">
...
<body ng-controller="miControlador">
 ...
 <div class="form-group">
  ...
  <p><button class="btn3" id='flecha_work'>Editar mi perfil</button></p> 
       ...
       <footer class="totalesparciales">

           <label id="ltotal" class="bidaia" for="total">TOTAL</label>            <label  id="total" name="total" type="text" class="emaitza">0</label> €/u
           
           <label class="emaitza" id="cantidad" name="total" type="text" class="emaitza">0</label>
           <input class="mas" name="btnHanditu" type="button" value="+" onclick="sumar()">
            <input class="menos" name="btnTxikitu" type="button" value="-" onclick="restar()">
            
            <BR>
            <form action="../controladores/controladorEnvioCompra.php" method="POST">
                  <input id="euro" name="euro" type="hidden" >
                <input id="cantidadTotal" name="cantidadTotal" type="hidden" >
