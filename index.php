...
<script>function scrollWaypointInit( items, trigger ) {
  items.each( function() {
    var element = $(this),
...
//    echo '<script>alert ("No encontramos ningún usuario con estos datos.\nPor favor, vuelva a intentarlo.");</script>';
  ...
  <div class="modal-content">
    <span class="close" ng-click="cerrar();">&times;</span>
    <p>No encontramos ningún usuario con estos datos. Por favor, vuelva a intentarlo.</p>
  </div>
...
?>
                ...
                <div class="menu">
                    <ul>
                        ...
                        if(isset($_SESSION['usuario'])){
                            ...
                            ?>
                        <li><a id="nav" class="nav" href="vistas/vistaEntradas.php">Entradas</a></li>
                            <?php
 ...
 <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="Usuario" placeholder="Introduce Usuario" name="Usuario" required>
    </div>
    <div class="form-group">
      <label for="Contraseña">Contraseña:</label>
      <input type="password" class="form-control" id="Contraseña" placeholder="Introduce Contraseña" name="pwd" required>
    </div>
    <div class="form-group">
      <label for="Nombre">Nombre:</label>
      <input type="text" class="form-control" id="Nombre" placeholder="Introduce Nombre" name="Nombre" required>
    </div>
    <div class="form-group">
      <label for="Apellido1">Apellido1:</label>
      <input type="text" class="form-control" id="Apellido1" placeholder="Introduce Apellido1" name="Apellido1" required>
    </div>
    <div class="form-group">
      <label for="Apellido2">Apellido2:</label>
      <input type="text" class="form-control" id="Apellido2" placeholder="Introduce Apellido2" name="Apellido2" required>
    </div>
                    
                     <div class="form-group">
      <label for="Fecha">Fecha Nacimiento:</label>
      <input type="date" class="form-control" id="Fecha" placeholder="Introduce Fecha" name="Fecha" required>
    </div>
                     <div class="form-group">
      <label for="Direccion">Direccion:</label>
      <input type="text" class="form-control" id="Direccion" placeholder="Introduce Direccion" name="Direccion" required>
    </div>
                     <div class="form-group">
      <label for="Correo">Correo:</label>
      <input type="email" class="form-control" id="Correo" placeholder="Introduce Correo" name="Correo" required>
    </div>
...
?>
        <div class="content animateMe container" data-animation="fadeInLeft" >
            ...
            <div class="" style="width: 25rem; margin: -5px; background-color: white; float: top; display: flex; height: 230px;" >
                ...
                <div class="card-body" style="background-color: white;margin-left: 20px; ">
                    ...
                    <h5 class="" style="  font-weight: bold;" > <?php echo $objGrupos->getNombreGrupo();?></h5>
                       ...
                       <a href="controladores/controladorBorrarGrupo.php?idGrupo=<?php echo $objGrupos->getIdGrupo(); ?>" id="BorrarGrupo"  onclick="return BorrarGrupo();" class="fas fa-times fa-2x BorrarGrupo" style="background: none; border: none; margin-left: 600px; margin-bottom: -95px;" ></a>
...
var modales = document.getElementById('myModales');
