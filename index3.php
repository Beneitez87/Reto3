...
$objGrupos->verInformacionGrupos($idGrupo);
...
?>
        <div class="content">
            ...
            <div class="" style="width: 25rem; margin: -5px; background-color: white; float: top; display: flex; height: 180px;" >
                ...
                <div class="card-body" style="background-color: white;margin-left: 20px; ">
                    ...
                    <h5 class="" style="  font-weight: bold;" > Concierto: <?php echo $objGrupos->getNombreGrupo();?></h5>
                       <div> <h5 style="  "> Ubicacion Sala: <?php echo $objGrupos->getDescripcion();?> </h5></div>
                       <form action="controladorCompra.php" method="POST">
                           <button  type="submit" class="fas fa-shopping-cart fa-2x" style="background: none; border: none; margin-left: 650px; margin-bottom: 50px;"> <input  name="idConciertoSala" type="hidden"  value="<?php echo $objGrupos->getIdConciertoSala();?>">  <input type="date"  value="<?php echo $objGrupos->getIdGrupo();?>" class="form-control" id="Fecha" placeholder="Introduce Fecha" name="Fecha" readonly> </button>
