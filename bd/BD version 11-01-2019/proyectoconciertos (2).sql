...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-01-2019 a las 11:11:15
...
CREATE TABLE `grupo` (
  ...
  `discos` varchar(100) NOT NULL,
  `descripcionCompleta` varchar(2000) NOT NULL,
...
('Diego sabe la descripcion', 1, 'WITHIN TEMPTATION', 'IMG/WithinTemptation.jpg', 'https://www.youtube.com/watch?v=S7sOZ_TFUXg', '', '', '', 0, ''),
('Green Day es una banda estadounidense de pop punk', 2, 'GREEN DAY', 'IMG/GreenDay.jpg', 'https://www.youtube.com/watch?v=Soa3gO7tL-c', '', '', '', 0, ''),
('Ir a la búsqueda Queen Brian May, Freddie Mercury, John Deacon y Roger Taylor. ', 3, 'QUEEN ', 'IMG/Queen.jpeg', 'https://www.youtube.com/watch?v=rY0WxgSXdEE', '', '', '', 0, ''),
('Coldplay es una banda británica de pop rock y rock alternativo formada en Londres en 1996. ', 4, 'COLDPLAY', 'IMG/ColdPlay.jpg', 'https://www.youtube.com/watch?v=dvgZkm1xWPE', '', '', '', 0, ''),
('Linkin Park es una banda estadounidense de rock alternativo procedente de Agoura Hills, California. ', 5, 'LINKIN PARK', 'IMG/LinkinPark.jpg', 'https://www.youtube.com/watch?v=kXYiU_JCYtU', '', '', '', 0, ''),
('a la búsqueda Para la revista musical, véase Rolling Stone. ', 6, 'ROLLING STONES', 'IMG/RollingStones.jpg', 'https://www.youtube.com/watch?v=nrIPxlFzDi0', '', '', '', 0, ''),
('The Black Eyed Peas es un grupo de música estadounidense de hip hop formado en 1995 en Los Ángeles ', 7, 'BLACK EYED PEAS ', 'IMG/BlackEyedPeas.jpg', 'https://www.youtube.com/watch?v=ZaI2IlHwmgQ', '', '', '', 0, ''),
('Evanescence es una banda estadounidense de rock fundada en Little Rock', 8, 'EVANESCENCE', 'IMG/Evanescence.jpg', 'https://www.youtube.com/watch?v=3YxaaGgTQYM', '', '', '', 0, ''),
('Paramore es una banda estadounidense de pop punk y rock alternativo', 9, 'PARAMORE', 'IMG/Paramore.jpg', 'https://www.youtube.com/watch?v=aCyGvGEtOwc', '', '', '', 0, ''),
('Guns N\' Roses es una banda estadounidense de hard rock formada en Hollywood', 10, 'GUNS N ROSES', 'IMG/GunsNRoses.jpg', 'https://www.youtube.com/watch?v=1w7OgIMMRc4', '', '', '', 0, ''),
('Jonas Brothers fue un grupo estadounidense de música', 11, 'JONAS BROTHERS', 'IMG/JonasBrother.jpg', 'https://www.youtube.com/watch?v=5KNEZJ6KkLI', '', '', '', 0, ''),
('El Canto del Loco (también abreviado ECDL) fue un grupo español de música pop rock', 12, 'EL CANTO DEL LOCO', 'IMG/CantoDelLoco.jpg', 'https://www.youtube.com/watch?v=n9jzGmFBzx8', '', '', '', 0, ''),
('Mecano fue un grupo español de música pop, activo entre 1981 y 1992', 13, 'MECANO', 'IMG/Mecano.jpg', 'https://www.youtube.com/watch?v=_mAmEKNqg1g', '', '', '', 0, ''),
('Backstreet Boys es una boy band estadounidense formada en Orlando, Florida, en 1993. ', 14, 'BACKSTREET BOYS', 'IMG/BlackEyedPeas.jpg', 'https://www.youtube.com/watch?v=ZaI2IlHwmgQ', '', '', '', 0, ''),
('The Killers es una banda de rock estadounidense formada en 2001 en Las Vegas (Nevada)', 15, 'THE KILLERS', 'IMG/BackStreetBoys.jpg', 'https://www.youtube.com/watch?v=6M6samPEMpM', '', '', '', 0, '');
